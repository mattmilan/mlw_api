...
class ContainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create container" do
    assert_difference('Container.count') do
      post containers_url, params: { container: { description: @container.description, element: @container.element, img_url: @container.img_url, name: @container.name, origin: @container.origin } }
    end
  ...
  test "should update container" do
    patch container_url(@container), params: { container: { description: @container.description, element: @container.element, img_url: @container.img_url, name: @container.name, origin: @container.origin } }
